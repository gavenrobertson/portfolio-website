                ...
                <div className="home-content">
                    <div className="hero-content">
                        <div className="hero-text">
                            <h1 ref={(el) => (elementsRef.current[0] = el)} className="h1-hero-heading hidden">Web <br/> Developer</h1>
                            <p ref={(el) => (elementsRef.current[1] = el)} className="p-hero-text hidden"> Hi, I'm Gaven. I am a passionate and driven Front-end Developer based out of Oregon, USA 🌎</p>
                            <span ref={(el) => (elementsRef.current[2] = el)} className="contacts hidden">
                        ...
                        <img ref={(el) => (elementsRef.current[3] = el)} className="dev-picture hidden" src={dev_picture}/>
                    </div>
                    <div className="tech-stack">
                        <div ref={(el) => (elementsRef.current[4] = el)} className="tech-stack-name hidden">Tech Stack</div>
